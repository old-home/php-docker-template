...
if (!function_exists('moveGitAttributes')) {
    function moveGitAttributes(): void
    {
        system('mv .gitattributes.default .gitattributes');
    }
}
...
if (!function_exists('setGitHubWebhook')) {
    function setGitHubWebhook(
        PackageName $packageName
    ): void
    {
        $token = $_ENV['GITHUB_TOKEN'];
